...
GITHUB_PASSOWRD_ENCODED=$(url_encode "$GITHUB_PASSOWRD")
...
git clone -b build$IDENTIFIER https://marcoprado17:$GITHUB_PASSOWRD_ENCODED@github.com/marcoprado17/crescer-saudavel-2.git .;
