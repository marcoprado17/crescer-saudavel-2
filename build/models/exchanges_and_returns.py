...
class ExchangesAndReturns(BaseModel):
    ...
    @staticmethod
    def get():
        all_exchanges_and_returns = ExchangesAndReturns.query.all()
        if len(all_exchanges_and_returns) != 1:
            raise InconsistentDataBaseError
        return all_exchanges_and_returns[0]
